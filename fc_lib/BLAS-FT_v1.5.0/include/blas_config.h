...
#define OPENBLAS_L2_SIZE 33554426-DL2_LINESIZE=64
...
#define OPENBLAS_CORE_FT2000 
#define OPENBLAS_CHAR_CORENAME "FT2000"
#define OPENBLAS_GEMM_MULTITHREAD_THRESHOLD 4
#define OPENBLAS_VERSION " OpenBLAS 1.0 "
