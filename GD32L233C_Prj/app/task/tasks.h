...
#define LORA_RECV_STK_SIZE        512         /* 接收+命令处理+send_waveform_packet(253B) */
#define WARNING_STK_SIZE          128         /* 事件等待, 够用 */
#define DANGER_STK_SIZE           128         /* 事件等待, 够用 */
#define WAVE_FLUSH_STK_SIZE       128         /* Flash刷新, 够用 */
 ...
 *                              公共函数声明
 *============================================================================*/
void send_data_packet(FrameType_t frame_type, ZDataPoint_t *data, uint8_t count);
