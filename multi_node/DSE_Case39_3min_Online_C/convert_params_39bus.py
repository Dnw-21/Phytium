...
py_dir = os.path.join(os.path.dirname(script_dir), 'DSE_Case39_3min_Online_Py')
...
print(f'Convert 39bus: n={n} s={s} ns={ns} nm={nm} fs={fs} samples={num_samples}')
